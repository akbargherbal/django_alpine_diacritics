  ...
  Alpine.data("sentHook", () => ({
    ...
    updateDictionariesAndState() {
      ...
      this.tokensCount = parseInt(
        document.getElementById("verse").getAttribute("data-tokens-count")
      );
      this.totalDiacritics = parseInt(
        document.getElementById("verse").getAttribute("data-dia-count")
      );
      this.mode = document.getElementById("verse").getAttribute("data-mode");
